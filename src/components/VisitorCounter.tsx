...
export function VisitorCounter() {
  ...
  return (
    <div className="inline-flex items-center gap-1.5 whitespace-nowrap rounded-full border border-white/15 bg-slate-950/30 px-3 py-1.5 text-xs text-white backdrop-blur-md" aria-live="polite">
      <Eye className="h-3.5 w-3.5 text-teal-300" aria-hidden="true" />
